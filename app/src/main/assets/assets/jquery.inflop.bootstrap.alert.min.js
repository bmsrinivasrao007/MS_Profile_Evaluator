...
! function (o) {
    o.fn.showBootstrapAlertSuccess = function (o, n, i, l) {
    ...
    }, o.fn.showBootstrapAlertDanger = function (o, n, i, l) {
        return this.showBootstrapAlert({
            message: o,
    ...
    }, o.fn.showBootstrapAlertWarning = function (o, n, i, l) {
        return this.showBootstrapAlert({
            message: o,
    ...
    }, o.fn.showBootstrapAlertInfo = function (o, n, i, l) {
        return this.showBootstrapAlert({
            message: o,
    ...
    }, o.fn.showBootstrapAlert = function (n) {
        var i = o.extend({
            message: null,
        ...
        return this.each(function () {
            var n = o(this);
            n.empty(), n.removeClass();
            var l = null;
            o(this).addClass(i.alertType.Background), i.dissmisable && (l = o("<button></button>").prop("type", "button").prop("aria-hidden", !0).html("&times;").addClass("close").click(function () {
                n.hide(200)
            }), o(this).append(l)), i.timeout > 0 && setTimeout(function () {
                n.hide(200)
            }, i.timeout);
            var p = o("<span></span>").prop("aria-hidden", !0).addClass(i.alertType.Icon),
                c = o("<div></div>").css("display", "inline").css("margin-left", "5px");
            switch (i.contentType) {
            case Bootstrap.ContentType.Html:
                c.html(i.message).find("a").addClass("alert-link");
                break;
            case Bootstrap.ContentType.Text:
                c.text(i.message)
            }
            o(this).append(p), o(this).append(c), o(this).show()
        })
    }
}(jQuery);
var Bootstrap = {
